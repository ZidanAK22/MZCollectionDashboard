...
export default function ProductPage() {
    ...
    return (
        <main 
        className="w-full h-screen flex flex-col gap-12 items-end pt-12 pr-60"
        style={{
                            ...
                            <CarouselItem key={index} className="basis-full" >
                                <div className="p-1 ">
                                    <Card style={{ borderRadius: "50px", backgroundColor: "white" }}>
                                        <CardContent className="flex items-center justify-center p-2 h-[400px]">
                                            <img 
                                                src={image} 
                                                alt={`Image ${index + 1}`} 
                                                style={{ borderRadius: "40px", height:"385px"}}
